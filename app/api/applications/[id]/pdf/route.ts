...
async function svgText(body: string) {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1100" height="1500"><style>text{font-family:Arial,"Noto Sans Bengali",sans-serif}</style>${body}</svg>`
