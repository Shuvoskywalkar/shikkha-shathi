...
const publisherOptions: Record<string, string[]> = {
  ...
  'পৌরনীতি ও সুশাসন ১ম পত্র': ['লেকচার', 'পাঞ্জেরী', 'অক্ষরপত্র'], 'পৌরনীতি ও সুশাসন ২য় পত্র': ['লেকচার', '���াঞ্�������েরী', 'অক্ষরপত্র'],
  ...
  'সমাজকর্ম ১ম পত্র': ['লেকচার', 'পাঞ্জেরী', 'অক্ষরপ����্র'], 'যুক্তিবিদ্��া ১ম পত্র': ['লেকচার', 'পাঞ্জেরী', 'অক্ষরপত্র'],
  'হিসাববিজ্ঞান ১ম পত্র': ['লেকচার', 'পাঞ্জেরী', 'অক্ষরপত্র'], 'হিসাববিজ্ঞান ২য় পত্র': ['লেকচার', 'পাঞ্জেরী', 'অক্ষরপত্র'],
  'ব্যবসায় সংগঠন ও ব্যবস্থাপনা ১ম পত্র': ['লেকচার', 'পাঞ্জেরী', 'অক্ষরপত্র'], 'ব্যবসায় সংগঠন ও ব্যবস্থাপনা ২য় পত্র': ['����েকচার', 'পাঞ্জেরী', 'অক্ষরপত্র'],
...
export default function Page() {
  ...
  const reset = () => { setSubmitted(null); setDept(''); setSelected([]); setCustomWriters({}); setSupplyNeeds({ calculator: '', geometryBox: '' }); setFiles({ admission: null, guardianProof: null }); setError(''); setFieldErrors({}) }
    ...
    <div className="wrap">
      <section className="card" id="form-card">
        ...
        {submitted ? <div className="confirm" id="confirmation-message" tabIndex={-1} role="status" aria-live="polite"><div className="confirm-badge"><Check size={32} /></div><h2>আবেদন সফলভাবে জমা হয়েছে</h2><p>তোমার তথ্য যাচাই করে আঞ্চলিক প্রতিনিধিরা প্রয়োজনে তোমার সাথে ফোনে যোগাযোগ করবেন। ধন্যবাদ!</p><div className="ref">{submitted.id}</div><button className="primary" onClick={reset}>আরেকটি আবেদন জমা দাও</button></div> : <form onSubmit={submit} noValidate>
          ...
          <section className="section"><SectionHead num="১" title="ব্যক্তিগত তথ্য" /><div className="field"><label>আবেদনকারীর নাম <span className="req">*</span></label><input name="name" placeholder="পূর্ণ নাম লিখুন" /></div><div className="grid2"><div className="field"><label>আবেদনকারীর মোবাইল নাম্বার <span className="req">*</span></label><input name="phone" type="tel" placeholder="01XXXXXXXXX" /><div className="hint">১১ ডিজিটের সচল নম্বর দিন</div></div><div className="field"><label>আবেদনকারী কোন চা-বাগানের অধিব��সী? <span className="req">*</span></label><input name="garden" placeholder="চা-বাগানের নাম" /></div></div><div className="field"><label>আবেদনকারীর অভিভা����ের পেশা <span className="req">*</span></label><input name="guardianJob" placeholder="যেমনঃ চা-শ্রমিক, দিনমজুর ইত্যাদি" /></div></section>
          <section className="section"><SectionHead num="২" title="শিক্ষা সংক্রান্ত তথ্য" /><div className="field"><label>আবেদনকারীর কলেজের নাম <span className="req">*</span></label><input name="college" placeholder="কলেজের পূর্ণ নাম" /></div><div className="grid2"><div className="field"><label>SSC পরীক্ষার ফলাফল (GPA) <span className="req">*</span></label><input name="gpa" type="number" min="1" max="5" step=".01" placeholder="যেমনঃ 4.50" /></div><div className="field"><label>আবেদনকারী কলেজে কোন বিভাগে অধ্যয়নরত? <span className="req">*</span></label><select value={dept} onChange={(e) => { setDept(e.target.value as Department); setSelected([]); setSupplyNeeds({ calculator: '', geometryBox: '' }) }}><option value="">বিভাগ নির্বাচন করুন</option><option value="science">বিজ্ঞান বিভাগ</option><option value="arts">মানবিক বিভাগ</option><option value="commerce">ব্যবসায় শিক্ষা বিভাগ</option></select></div></div></section>
          <section className="section"><SectionHead num="৩" title="ভবিষ্যৎ পরিকল্পনা" /><div className="field"><label>সংক্ষেপে লিখো— উচ্চমাধ্যমিক পাশ করার পরবর্তী পরিকল্পনা কী তোমার? এইচএসসি শেষে কী করতে চাও? <span className="req">*</span></label><textarea name="futurePlan" rows={7} placeholder="সংক্ষেপে লিখো— উচ্চমাধ্যমিক পাশ করার পরবর্তী পরিকল্পনা কী তোমার? এইচএসসি শেষে কী করতে চাও?" /></div></section>
