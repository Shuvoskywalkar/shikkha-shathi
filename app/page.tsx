...
const publisherOptions: Record<string, string[]> = {
  ...
  'সমাজকর্ম ১ম পত্র': ['লেকচার', 'পাঞ্জেরী', 'অক্ষরপত্র'], 'যুক্তিবিদ্��া ১ম পত্র': ['লেকচার', 'পাঞ্জেরী', 'অক্ষরপত্র'],
