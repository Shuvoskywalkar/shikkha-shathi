  ...
  return <main>
    ...
    <section className="hero">
      <div className="hero-inner">
        ...
        <p className="hero-description">এসএসসি পাশ করে একাদশ শ্রেণিতে ভর্তি হতে যাচ্ছ? তথ্য যাচাই, বাছাই ও ভাইভার মাধ্যমে যোগ্য শিক্ষার্থীদের চূড়ান্তভাবে নির্বাচন করা হবে।</p><p className="hero-note">পারিবারিক আর্থিক অবস্থা, ভাইভার ফলাফল ও উচ্চশিক্ষার প্রতি আগ্রহ বিবেচনায় নির্বাচন করা হবে।</p>
      </div>
    ...
    <div className="wrap">
      ...
      <section className="future-plan" aria-labelledby="future-plan-title"><div className="future-plan-header"><span className="future-plan-kicker">আগামীর পরিকল্পনা</span><h2 id="future-plan-title">সকল আবেদনকারীর জন্য দীর্ঘমেয়াদি পরিকল্পনা</h2><p>বই-সংক্রান্ত সহায়তার জন্য কোনো শিক্ষার্থী নির্বাচিত হোক বা না হোক, প্রত্যেক আবেদনকারীকে একাদশ–দ্বাদশ শ্রেণিকালে শিক্ষা সহায়তা ও উন্নয়নমূলক কার্যক্রমের আওতায় আনার সম্ভাবনা নিয়ে কাজ করা হবে।</p></div><div className="future-plan-grid"><article><span className="future-plan-number">০১</span><h3>নিয়মিত দিকনির্দেশনা</h3><p>শিক্ষাজীবনের গুরুত্বপূর্ণ সিদ্ধান্ত ও প্রস্তুতিতে ধারাবাহিক পরামর্শ।</p></article><article><span className="future-plan-number">০২</span><h3>ফলাফলভিত্তিক সহায়তা</h3><p>শিক্ষার্থীর অগ্রগতি ও ফলাফলের ভিত্তিতে সম্ভাব্য আর্থিক সহযোগিতা।</p></article><article><span className="future-plan-number">০৩</span><h3>বিনামূল্যে ক্লাস</h3><p>পেশাদার শিক্ষকদের মাধ্যমে বাংলা, ইংরেজি ও সাধারণ জ্ঞানের মাসিক ক্লাস এবং পর্যায়ক্রমিক মূল্যায়ন।</p></article></div><div className="future-plan-goal"><strong>লক্ষ্য</strong><span>চা-বাগান অঞ্চলের শিক্ষার্থীদের উচ্চশিক্ষার পথে এগিয়ে যেতে উৎসাহ, দিকনির্দেশনা ও সহায়তা প্রদান করা।</span></div></section><footer><button className="admin-link" aria-label="প্রশাসন প্যানেল" onClick={() => setShowAdmin((value) => !value)}><LockKeyhole size={16} /></button></footer>
