  ...
  return <main>
    ...
    <section className="hero">
      <div className="hero-inner">
        ...
        <p className="hero-description">এসএসসি পাশ করে একাদশ শ্রেণিতে ভর্তি হতে যাচ্ছ? তথ্য যাচাই, বাছাই ও প্রয়োজনে ভাইভার মাধ্যমে চূড়ান্তভাবে নির্বাচিত শিক্ষার্থীদের প্রয়োজনীয় বই, ক্যালকুলেটর ও জ্যামিতি বক্স দিয়ে সহায়তা করা হবে।</p><p className="hero-note">পারিবারিক আর্থিক অবস্থা, ভাইভার ফলাফল ও উচ্চশিক্ষার প্রতি আগ্রহ বিবেচনায় চূড়ান্ত নির্বাচন করা হবে। নির্বাচিতরা কাঙ্ক্ষিত পাঠ্যবই পাবে।</p>
      </div>
    ...
    <div className="wrap">
      ...
      <section className="card program-plan"><h2>সকল আবেদনকারীর জন্য দীর্ঘমেয়াদি পরিকল্পনা</h2><p>বই সহায়তার জন্য নির্বাচিত হোক বা না হোক, প্রত্যেক আবেদনকারীকে একাদশ–দ্বাদশ শ্রেণিতে শিক্ষা সহায়তা ও উন্নয়নমূলক কার্যক্রমের আওতায় আনার পরিকল্পনা রয়েছে।</p><ul><li>নিয়মিত দিকনির্দেশনা</li><li>ফলাফলের ভিত্তিতে আর্থিক সহযোগিতা</li><li>বাংলা, ইংরেজি ও সাধারণ জ্ঞানের বিনামূল্যে ক্লাস ও পর্যায়ক্রমিক মূল্যায়ন</li></ul></section><footer><button className="admin-link" aria-label="প্রশাসন প্যানেল" onClick={() => setShowAdmin((value) => !value)}><LockKeyhole size={16} /></button></footer>
