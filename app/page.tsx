...
export default function Page() {
  ...
  const submit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      payload.set('department', dept); payload.set('books', JSON.stringify(selected)); payload.set('bookWriters', JSON.stringify(Object.fromEntries(selected.map((book) => [book, customWriters[book] || '']))))
