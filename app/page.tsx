  ...
  return <main>
    ...
    <section className="hero">
      <div className="hero-inner">
        ...
        <p className="hero-description">এসএসসি পাশ করে একাদশ শ্রেণিতে ভর্তি হতে যাচ্ছ? তথ্য যাচাই, বাছাই ও প্রয়োজনে ভাইভার মাধ্যমে চূড়ান্তভাবে নির্বাচিত শিক্ষার্থীদের প্রয়োজনীয় বই, ক্যালকুলেটর ও জ্যামিতি বক্স দিয়ে সহায়তা করা হবে।</p>
      </div>
