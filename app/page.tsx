...
export default function Page() {
  ...
  return <main>
    ...
    <div className="wrap">
      ...
      <section className="card program-plan"><div className="section-head"><span className="section-num">পরিকল্পনা</span><h2>আবেদনকারীদের নিয়ে ভবিষ্যৎ পরিকল্পনা</h2></div><p>বই সহায়তার জন্য নির্বাচিত হোক বা না হোক, প্রত্যেক আবেদনকারীকে একাদশ–দ্বাদশ শ্রেণিতে শিক্ষা সহায়তা ও উন্নয়নমূলক কার্যক্রমের সঙ্গে যুক্ত রাখার পরিকল্পনা রয়েছে।</p><ul><li>নিয়মিত দিকনির্দেশনা ও শিক্ষাগত পরামর্শ</li><li>ফলাফলের ভিত্তিতে সম্ভাব্য আর্থিক সহযোগিতা</li><li>বাংলা, ইংরেজি ও সাধারণ জ্ঞানের বিনামূল্যে ক্লাস এবং পর্যায়ক্রমিক মূল্যায়ন</li></ul></section><footer><button className="admin-link" aria-label="প্রশাসন প্যানেল" onClick={() => setShowAdmin((value) => !value)}><LockKeyhole size={16} /></button></footer>
